...
const Header: React.VFC<Props> = (props) => {
  return (
    <header className='relative w-full h-16 bg-gray-100 sm:h-12'>
      <div className='absolute top-0 left-0 w-16 h-16 sm:w-12 sm:h-12'>
        <Image src='/logo.png' alt='ロゴ' width='64px' height='64px' layout='responsive' />
      </div>
      <p className='absolute top-0 left-20 h-16 leading-16 text-lg font-black sm:left-14 sm:h-12 sm:leading-12 sm:text-sm'>
        アパレル事業者のための情報共有ツール
      </p>
      {/* ログイン前と後でヘッダー内容を切替える */}
